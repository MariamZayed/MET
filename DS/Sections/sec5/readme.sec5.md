...
| الحالة                                 | الإجراء                                              |
| -------------------------------------- | ---------------------------------------------------- |
| لو الرمز **Operand** (زي `A` أو `3`)   | نحطه على طول في الـ **Postfix**                      |
| لو الرمز **Operator** (زي `+` أو `*`)  | نقرر بناءً على حالة الـ Stack:                       |
| → لو الـStack فاضي                     | نحطه في الـStack                                     |
| → لو مش فاضي                           | نقارن أولوية العملية الجديدة باللي فوق الـStack      |
| لو الجديدة **أعلى أولوية**             | نحطها في الـStack                                    |
| لو اللي فوق الـStack **أعلى أو مساوي** | نطلعه (pop) ونضيفه في الـPostfix، وبعدين نحط الجديدة |
| لو لقينا `(`                           | نحطها في الـStack                                    |
| لو لقينا `)`                           | نطلع كل العمليات لحد ما نوصل لـ `(`                  |
| في الآخر                               | نطلع أي عمليات لسه في الـStack ونضيفها في الآخر      |
